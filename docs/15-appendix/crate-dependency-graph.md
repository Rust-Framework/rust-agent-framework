...
| `rust-agent-llama` | `crates/llama/` | `rust-agent-core` |
...
| `rust-agent-decl` | `crates/decl/` | `rust-agent-core`, `rust-agent-client`, `rust-agent-framework`, `rust-agent-workflow`, `rust-agent-rhai`, `rust-agent-websearch`*, `rust-agent-rag`*, `rust-agent-wiki`*, `rust-agent-openapi`*, `rust-agent-sandbox`*, `rust-agent-llama`* |
...
| **rust-agent-llama** | 本地推理：基于 llama-gguf 的 GGUF IChatClient 实现 |
...
| `llama-gguf` | 本地 GGUF 推理引擎（rust-agent-llama，crates.io） |
