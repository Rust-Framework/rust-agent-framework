...
const TMPL_PAPER: &str = include_str!("../templates/paper.md");
const TMPL_DOC: &str = include_str!("../templates/doc.md");
const TMPL_SECTION: &str = include_str!("../templates/section.md");
const TMPL_QUERY_RESULT: &str = include_str!("../templates/query-result.md");
