...
use rust_agent_rag::{InMemoryVectorStore, IVectorStore};
...
async fn build_retriever(source: &str) -> rust_agent_rag::Result<SimilarityRetriever> {
...
async fn index_document(
    ...
    model: &rust_agent_rag::EmbeddingModel,
    store: &mut InMemoryVectorStore,
    content: &str,
) -> rust_agent_rag::Result<()> {
